                    ...
                    <?php else: ?>
                        <div class="categories-grid">
                            <?php foreach ($pageData['available_categories'] as $category): 
                                ...
                                $canVote = $status && !$status['has_voted'] && $status['is_active'] && $status['has_nominations'];
                                $hasNominations = $status['has_nominations'] ?? false;
                            ?>
                            <div class="category-card <?php echo $status && $status['has_voted'] ? 'voted' : ''; ?>"
                                ...
                                <div class="category-body">
                                    ...
                                    <div class="category-stats">
                                        ...
                                        <div class="stat">
                                            <div class="number"><?php echo $canVote ? 'OUI' : 'NON'; ?></div>
