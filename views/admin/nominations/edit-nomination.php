...
$nominationData = $nominationController->getService()->getNominationById($nomination_id);
...
$nomination = [
    'id_nomination' => $nominationData['id_nomination'],
    'titre' => $nominationData['libelle'],
    'candidat_nom' => $nominationData['pseudonyme'] ?? $nominationData['candidat_nom'] ?? 'Anonyme',
    'candidat_username' => '', // Pode precisar de ajuste dependendo da estrutura
    'candidat_email' => $nominationData['candidat_email'] ?? '',
    'candidat_phone' => '', // Campo não presente no banco atual
    'plateforme' => $nominationData['plateforme'],
    'id_categorie' => $nominationData['id_categorie'],
    'id_edition' => 1, // Precisa ser obtido da categoria
    'argumentation' => $nominationData['argumentaire'],
    'image_url' => !empty($nominationData['url_image']) ? 
                   '/Social-Media-Awards-/' . htmlspecialchars($nominationData['url_image']) : 
                   '',
    'lien_contenu' => $nominationData['url_contenu'],
    'statistiques' => '', // Campo não presente no banco atual
    'date_soumission' => $nominationData['date_approbation'],
    'statut' => 'approved' // Padrão para nomeações já criadas
];
...
// Obter edições (precisa de um EditionService)
    ...
    <div class="card">
        <div class="card-header">
            ...
            <p class="card-subtitle">ID: #<?php echo $nomination_id; ?> | Statut: 
                ...
                | Date: <?php echo date('d/m/Y H:i', strtotime($nomination['date_soumission'])); ?>
            </p>
        </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <div class="image-preview-container">
                            <?php if (!empty($nomination['image_url']) && $nomination['image_url'] != '/Social-Media-Awards-/assets/images/default-avatar.png'): ?>
                            ...
                            <div class="file-upload">
                                ...
                                <label for="image_file" class="file-upload-label">
                                    ...
                                    <span><?php echo empty($nomination['image_url']) || $nomination['image_url'] == '/Social-Media-Awards-/assets/images/default-avatar.png' ? 'Choisir une image' : 'Remplacer l\'image'; ?></span>
                                </label>
...
<script>
    // Compteur de caractères para a argumentação
    ...
    if (removeImageBtn) {
        removeImageBtn.addEventListener('click', function() {
            if (confirm('Supprimer l\'image actuelle ?')) {
                ...
                // Atualizar label do botão de upload
