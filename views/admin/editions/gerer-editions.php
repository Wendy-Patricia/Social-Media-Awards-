                ...
                <table class="enhanced-table">
                    ...
                    <tbody>
                        <?php foreach ($editions as $e):
                            $status = (new \App\Models\Edition($e))->getStatus();
                        ...
                        <tr>
                            ...
                            <td class="actions-cell">
                                <a href="modifier-edition.php?id=<?= $e['id_edition'] ?>" class="action-btn edit" title="Modifier">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <a href="#" onclick="confirmDelete(<?= $e['id_edition'] ?>, '<?= addslashes($e['nom']) ?>')" class="action-btn delete" title="Supprimer">
