    ...
    <div class="card-body">
        ...
        <ul class="nav-candidat">
            ...
            <?php if ($isNominee): ?>
                ...
                <li>
                    <a class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'perfil-candidat.php' ? 'active' : '' ?>"
                        href="perfil-candidat.php">
                        <i class="fas fa-id-badge"></i>
                ...
                <li>
                    <a class="nav-link <?= basename($_SERVER['PHP_SELF']) == 'results.php' ? 'active' : '' ?>"
                        href="/Social-Media-Awards-/results.php">
            ...
            <?php else: ?>
                ...
                <!-- Perfil -->
                <li>
                    <a class="nav-link" href="/Social-Media-Awards-/views/candidate/perfil-candidat.php">
