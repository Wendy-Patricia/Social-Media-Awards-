...
<body class="bg-light">
                                ...
                                <div class="card-header">
                                    <div class="nomination-header">
                                        ...
                                        <span class="status-badge <?= $statusClass ?>">
                                            <?= $status == 'in_progress' ? 'Votes en cours' : ($status == 'ended' ? 'Votes terminés' : 'Votes non commencés') ?>
                                        </span>
                                    </div>
                                </div>
                                <div class="card-body">
                        ...
                        <?php if ($availableCount > 0): ?>
                            <div class="opportunity-alert">
                                <div class="d-flex align-items-start">
                                    ...
                                    <div style="flex: 1;">
                                        <h5 class="mb-2"><?= $availableCount ?> nouvelle(s) catégorie(s) disponible(s)</h5>
                                        <p class="mb-3">
                                            Il vous reste <?= $availableCount ?> catégorie(s) où vous pouvez encore soumettre une candidature.
                                        ...
                                        <?php if (count($availableCategories) > 0):
                                            $displayCategories = array_slice($availableCategories, 0, 3);
                                        ?>
                                                ...
                                                ?>
                                                    <div class="category-card">
                                                        <div class="category-header">
                                                            ...
                                                            <span class="category-edition"><?= htmlspecialchars($category['edition_nom']) ?></span>
                                                        </div>
                                                        ...
                                                        <div class="category-details">
                                                            <div>
                                                                <?php if ($category['plateforme_cible']): ?>
                                                                    <div><i class="fas fa-globe me-1"></i> <?= htmlspecialchars($category['plateforme_cible']) ?></div>
                                                                <?php endif; ?>
                                                            </div>
                                                            <div class="text-end">
                                                                <div><i class="fas fa-clock me-1"></i> J-<?= $daysLeft ?></div>
                                                        ...
                                                        <a href="soumettre-candidature.php?categorie=<?= $category['id_categorie'] ?>"
                                            ...
                                            <?php if (count($availableCategories) > 3): ?>
                                                <div class="text-center mt-3">
                                                    <button type="button" class="btn btn-outline-primary"
                                                        ...
                                                        Voir les <?= count($availableCategories) - 3 ?> autres catégories
                                                    </button>
                                                </div>
                                            <?php endif; ?>
                                        <?php endif; ?>
    ...
    <!-- Modal para mostrar todas as categorias disponíveis -->
    <?php if (count($availableCategories) > 0): ?>
                ...
                <div class="modal-content">
                    <div class="modal-header bg-primary text-white">
                        <h5 class="modal-title">
                            ...
                            Toutes les catégories disponibles (<?= count($availableCategories) ?>)
                        </h5>
                            ...
                            ?>
                                <div class="col-md-6 mb-3">
                                    <div class="category-card h-100 <?= $isUrgent ? 'border-danger' : '' ?>">
                                        ...
                                        <div class="category-header">
                                            <h6 class="category-title"><?= htmlspecialchars($category['nom']) ?></h6>
                                            <span class="badge bg-info"><?= htmlspecialchars($category['edition_nom']) ?></span>
                                        </div>
                                            ...
                                            <div>
                                                <?php if ($category['plateforme_cible']): ?>
                                                    <div class="mb-1">
                                                        ...
                                                        <small><?= htmlspecialchars($category['plateforme_cible']) ?></small>
                                                    </div>
                                                <?php endif; ?>

                                                <div class="mb-1">
                                                    <i class="fas fa-user-friends me-1 text-success"></i>
                                                    <small><?= $category['limite_nomines'] ?> nominés maximum</small>
                                                </div>
                                                ...
                                                ?>
                                                    <div class="mb-1">
                                                        ...
                                                        <small>Votes: <?= $startVotes->format('d/m') ?> - <?= $endVotes->format('d/m/Y') ?></small>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                        ...
                                        <div class="d-grid gap-2 mt-3">
                                            ...
                                            <button type="button" class="btn btn-outline-secondary"
                                                onclick="shareCategory('<?= htmlspecialchars($category['nom']) ?>', <?= $category['id_categorie'] ?>)">
    ...
    <script>
        ...
        // Função para compartilhar categoria
        function shareCategory(categoryName, categoryId) {
            const url = window.location.origin + '/Social-Media-Awards-/views/candidate/soumettre-candidature.php?categorie=' + categoryId;
