...
<body>
    ...
    <div class="main-content">
        ...
        <section class="hero-banner">
            <div class="banner-container"><img src="assets/images/banner1.png" alt="Bannière Social Media Awards 2025" class="hero-banner-image">
                <div class="banner-overlay">
                    <div class="banner-text">
                        ...
                        <div class="banner-buttons">
                            <button class="btn-primary" onclick="scrollToSection('categories')">
                                <i class="fas fa-vote-yea"></i>
                                Commencer à Voter
                            </button>
                            <button class="btn-secondary" onclick="scrollToSection('edition-info')">
